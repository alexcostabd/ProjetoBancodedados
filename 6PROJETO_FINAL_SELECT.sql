/*
* VERIFICA OS RECEBIMENTOS DE USU�?RIOS EM UMA DETERMINADA FAIXA DE TEMPO.
*/
SELECT 
    USU.usu_cpf "CPF DO USU�?RIO", 
    USU.usu_nome "NOME DO USU�?RIO",
...
/*
* VERIFICA OS RECEBIMENTO DE USU�?RIOS EM UMA DETERMINADA FAIXA DE TEMPO.
*/
SELECT
    DISTINCT USU.usu_nome "NOME FUNCION�?RIO",
    TEL.tel_ddd "DDD",
    TEL.tel_numero "TELEFONE",
    STR.tip_descricao "SETOR",
    EMP.emp_nome_fantasia "NOME DA EMPRESA",
    TPF.funcao_salario "SAL�?RIO"
FROM 
    USUARIO USU, 
    FUNCIONARIO FUN,
    TELEFONE TEL,
...
SELECT 
    ...
    EMP.emp_nome_fantasia "NOME DA EMPRESA",
    TREMP.traEmp_descricao "DESCRI��O DA TRANSA��O",
