...
CREATE TABLE USUARIO(USU_ID NUMBER NOT NULL PRIMARY KEY, USU_CPF VARCHAR2(15)NOT NULL, USU_RG VARCHAR2(15)NOT NULL, USU_EMAIL VARCHAR2(200)NOT NULL, USU_NOME VARCHAR2(200)NOT NULL, USU_SENHA VARCHAR2(20)NOT NULL);

CREATE TABLE ENDERECO(END_ID NUMBER NOT NULL PRIMARY KEY, USU_ID NUMBER NOT NULL, END_CEP VARCHAR2(10)NOT NULL, END_LOGRADOURO VARCHAR2(150)NOT NULL, END_NUMERO NUMBER, END_COMPLEMENTO VARCHAR2(50), END_CIDADE VARCHAR2(150)NOT NULL, END_ESTADO VARCHAR2(100)NOT NULL, END_BAIRRO VARCHAR2(100)NOT NULL);
ALTER TABLE ENDERECO ADD FOREIGN KEY(USU_ID)REFERENCES USUARIO(USU_ID);

CREATE TABLE TELEFONE(TEL_ID NUMBER NOT NULL PRIMARY KEY, USU_ID NUMBER NOT NULL, TEL_DDD NUMBER NOT NULL, TEL_NUMERO VARCHAR2(10)NOT NULL);
ALTER TABLE TELEFONE ADD FOREIGN KEY(USU_ID)REFERENCES USUARIO(USU_ID);

CREATE TABLE EMPRESA(EMP_ID NUMBER NOT NULL PRIMARY KEY, EMP_CNPJ VARCHAR2(20)NOT NULL, EMP_INCRICAO_MUNICIPAL VARCHAR2(25)NOT NULL, EMP_INCRICAO_ESTADUAL VARCHAR2(25)NOT NULL, EMP_NOME_FANTASIA VARCHAR2(150)NOT NULL, EMP_RAZAO_SOCIAL VARCHAR2(200)NOT NULL);

CREATE TABLE ENDERECO_EMPRESA(EMPEND_ID NUMBER NOT NULL PRIMARY KEY, EMP_ID NUMBER NOT NULL, EMPEND_CEP VARCHAR2(10)NOT NULL, EMPEND_LOGRADOURO VARCHAR2(150)NOT NULL, EMPEND_NUMERO NUMBER, EMPEND_COMPLEMENTO VARCHAR2(50), EMPEND_CIDADE VARCHAR2(150)NOT NULL, EMPEND_ESTADO VARCHAR2(100)NOT NULL, EMPEND_BAIRRO VARCHAR2(100)NOT NULL, EMPEND_EMAIL VARCHAR2(200), EMPEND_SITE VARCHAR2(200));
ALTER TABLE ENDERECO_EMPRESA ADD FOREIGN KEY(EMP_ID)REFERENCES EMPRESA(EMP_ID);

CREATE TABLE TELEFONE_EMPRESA(EMPTEL_ID NUMBER NOT NULL PRIMARY KEY, EMP_ID NUMBER NOT NULL, EMPTEL_DDD NUMBER NOT NULL, EMPTEL_NUMERO VARCHAR2(20)NOT NULL);
ALTER TABLE TELEFONE_EMPRESA ADD FOREIGN KEY(EMP_ID)REFERENCES EMPRESA(EMP_ID);

CREATE TABLE ALUNO(ALU_RA NUMBER NOT NULL PRIMARY KEY, USU_ID NUMBER NOT NULL, EMP_ID NUMBER NOT NULL);
...
CREATE TABLE SOCIO(SOC_ID NUMBER NOT NULL PRIMARY KEY, USU_ID NUMBER NOT NULL, EMP_ID NUMBER NOT NULL);
...
CREATE TABLE TIPO_SETOR(TIP_SETORID NUMBER NOT NULL PRIMARY KEY, TIP_DESCRICAO VARCHAR2(100)NOT NULL, EMP_ID NUMBER NOT NULL);
ALTER TABLE TIPO_SETOR ADD FOREIGN KEY(EMP_ID)REFERENCES EMPRESA(EMP_ID);

CREATE TABLE TIPO_FUNCAO(FUNCAO_ID NUMBER NOT NULL PRIMARY KEY, FUNCAO_DESCRICAO VARCHAR2(100)NOT NULL, FUNCAO_SALARIO NUMBER(10, 2)NOT NULL, EMP_ID NUMBER NOT NULL, TIP_SETORID NUMBER NOT NULL);
...
CREATE TABLE FUNCIONARIO(FUN_ID NUMBER NOT NULL PRIMARY KEY, FUN_CTPS VARCHAR2(20)NOT NULL, USU_ID NUMBER NOT NULL, EMP_ID NUMBER NOT NULL);
...
CREATE TABLE FUNCAO_FUNC(FUN_ID NUMBER NOT NULL, FUNCAO_ID NUMBER NOT NULL, EMP_ID NUMBER NOT NULL);
...
CREATE TABLE HISTORICO_TIPO_FUNCAO(DATA DATE, USER_LOG VARCHAR2(30), FUNCAO_ID NUMBER NOT NULL, FUNCAO_DESCRICAO VARCHAR2(100)NOT NULL, FUNCAO_SALARIO NUMBER(10, 2)NOT NULL, EMP_ID NUMBER NOT NULL, TIP_SETORID NUMBER NOT NULL);