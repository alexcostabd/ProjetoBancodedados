...
SELECT
S.TIP_DESCRICAO AS SETOR,
(SELECT SUM(TF.FUNCAO_SALARIO)FROM FUNCAO_FUNC FF INNER JOIN TIPO_FUNCAO TF ON TF.FUNCAO_ID = FF.FUNCAO_ID AND TF.TIP_SETORID = S.TIP_SETORID)AS CUSTO_SALARIAL
FROM TIPO_SETOR S
WHERE S.EMP_ID = 2020060001;

/* CUSTO MÉDIO DE SALÁRIO DOS SETORES DE UMA EMPRESA*/
SELECT
S.TIP_DESCRICAO AS SETOR,
(SELECT AVG(TF.FUNCAO_SALARIO)FROM FUNCAO_FUNC FF INNER JOIN TIPO_FUNCAO TF ON TF.FUNCAO_ID = FF.FUNCAO_ID AND TF.TIP_SETORID = S.TIP_SETORID)AS MÉDIA_SALARIAL
FROM TIPO_SETOR S
WHERE S.EMP_ID = 2020060001;